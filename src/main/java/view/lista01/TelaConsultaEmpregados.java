...
import controller.lista01.EmpregadoController;
...
public class TelaConsultaEmpregados extends JFrame {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addGap(225).addComponent(btnBuscar))
								.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
										.addComponent(tblEmpregados, GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE))
								.addGroup(gl_contentPane.createSequentialGroup().addGap(145).addComponent(btnExcluir)
										.addGap(111).addComponent(btnEditar)))
						.addContainerGap()));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addGap(19).addComponent(btnBuscar).addPreferredGap(ComponentPlacement.RELATED)
	...
	private void limparTabelaEmpregados() {
		tblEmpregados.setModel(new DefaultTableModel(new Object[][] { nomesColunas, }, nomesColunas));
	}
