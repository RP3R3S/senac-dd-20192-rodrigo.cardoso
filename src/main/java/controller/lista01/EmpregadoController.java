package controller.lista01;

import java.util.ArrayList;

import model.bo.lista01.EmpregadoBO;
import model.dao.lista01.EmpregadoDAO;
...
public class EmpregadoController {
	...
	/**
	 * Recebe os dados para salvar um novo empregado, valida todos os campos e por
	 * fim chama o BO responsável por chamar o DAO.
	 * 
	 * @param nome
	 * @param cpf
	 ...
	 * @param comissao
	 * 
	 * @return a mensagem de validação dos campos E também o retorno da chamada ao
	 *         BO.
	 */
	public String salvar(String nome, String cpf, char sexoSelecionado, int idade, String salarioBruto, String tipo,
			String comissao) {
